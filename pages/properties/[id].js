...
const SingleProperty = () => {
    ...
    const getSinglePropertiesData = async () => {
        const data = await Axios.get(`http://localhost:7000/${router.query.id}`);
                ...
                <div className="text-center">
                    <div>
                        <a href>
                            <span className="text-white text-xs whitespace-nowrap">
                                All Rights Reserved. © Copyright 2023 Codesoftic Tech
                                Private Limited.
                            </span>
                        </a>
                    </div>
                    <div>
                        <a href="https://codesoftic.com/">
                            ...
                            <img src="/image/footer logo.png" className="w-24 block mx-auto " />
                        </a>
                    </div>
                </div>
            </section>
